...
@app.route('/')
def homepage():
	return " Welcome to the simple employee expense management system"
...
def post():
	try:
		...
		new_expense = Expense(data['name'], data['email'], data['category'], data['description'], data['link'], data['estimated_costs'], data['submit_date'])
